...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		option.scrollSpeed = 0.7;
		option.minValue = 0.1;
		option.maxValue = 1.02;
		option.changeValue = 0.05;
		option.displayFormat = '%vX';
		option.decimals = 2;
		optionsArray.push(option);
		...
		optionsArray.push(new GameplayOption('Instakill', 'instakill', 'bool', false));
		optionsArray.push(new GameplayOption('Practice', 'practice', 'bool', false));
